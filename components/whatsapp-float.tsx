export function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/524792677777"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Escríbenos por WhatsApp"
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-foreground/20 transition-transform duration-300 hover:scale-110"
    >
      <svg
        width={28}
        height={28}
      ...
      <span className="pointer-events-none absolute right-16 whitespace-nowrap rounded-full bg-foreground px-3 py-1.5 text-sm text-background opacity-0 transition-opacity duration-300 group-hover:opacity-100">
        ¿Hablamos?
      </span>
    </a>
  )
